...
import { login, urls } from '../../../../api/api'
...
<div className='flex justify-center items-center mb-8'><h1 className='text-neutral-900 dark:text-white text-2xl font-medium'>Login</h1></div>
...
<div className='flex justify-center items-center'>
    <button onClick={send} className='mt-5 cursor-pointer text-gray-50 py-3 px-5 rounded-lg font-medium bg-blue-700 hover:bg-blue-800'>Login</button></div>
    <div className='flex justify-center font-light text-sm mt-5'>

    <span className='mr-2'>If you dont have account </span><Link className='text-blue-700 cursor-pointer'href='/register'>Sing Up</Link>
      </div>
  </form>
  </div>
  )
